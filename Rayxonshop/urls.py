"""
URL configuration for Rayxonshop project.
...
urlpatterns = [
    path('', include('main.urls')),  # main appni ilovaga qo'shish
    path('admin/', admin.site.urls),
    path('api-docs/', schema_view.with_ui('swagger', cache_timeout=0), name='schema-swagger-ui'),
    path('api/bijuteriya/', include('bijuteriya.urls')),
    path('api/boshqa/', include('boshqa.urls')),
    path('api/dress/', include('dress.urls')),
    path('api/handbag/', include('handbag.urls')),
